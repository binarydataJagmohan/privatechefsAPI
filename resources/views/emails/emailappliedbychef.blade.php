                        ...
                        <td class="content-wrap"
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                              ...
                              <td
                                        ...
                                        valign="top">
                                        Chef Application for BookingId #{{$data['booking_id']}}
                                    </td>
                                    </tr>
                                ...
                                <td class="content-block"
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                        valign="top">
                                        I hope this email finds you well. I am writing to inform you that a chef has applied to your booking with the following details:
                                    </td>
                                    </tr>
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
                                ...
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                        valign="top">
                                        The chef has expressed interest in catering to your event and would like to discuss the specifics further. We recommend contacting the chef directly to discuss your requirements, menu preferences, and any other relevant details. You can reach out to the chef using the provided email or contact number mentioned above.
                                    </td>
                                </tr>
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
